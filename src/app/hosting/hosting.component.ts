...
getResourceGroupDetails(){
  this.dialogRef = this.dialog.open(DialogDataExampleDialog, { disableClose: true,backdropClass: 'backdropBackground',
  hasBackdrop : true });
...
getACRDetails(){
  this.registryDialogRef = this.dialog.open(DialogDataRegistryDialog, { disableClose: true, backdropClass: 'backdropBackground',
          hasBackdrop : true }, );
